...
INSERT INTO properties (owner_id, title, desc, thumbnail, cover, cost, parking, bathrooms, bedrooms, country, street, city, province, post_code, active)
...
VALUES 
    ...
    ('2023-03-25', '2023-03-30', 2, 1),
    ('2023-04-05', '2023-04-10', 3, 2);

INSERT INTO property_reviews (property_id, guest_id, rating, review)
VALUES 
    (1, 1, 4, 'Great location, clean and comfortable.'),
    (2, 1, 5, 'Absolutely stunning property. Exceeded all our expectations.'),
    (3, 2, 3, 'Nice place, but could use some updating.');
